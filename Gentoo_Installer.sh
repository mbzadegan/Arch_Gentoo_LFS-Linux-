...
USER_NAME="user"
USER_PASS="User"
STAGE3_URL=$(curl -s https://gentoo.osuosl.org/releases/amd64/autobuilds/latest-stage3-amd64-openrc.txt | grep -v '^#' | head -n 1 | awk '{print $1}')
...
# --- STAGE3 ---
cd /mnt/gentoo
wget https://gentoo.osuosl.org/releases/amd64/autobuilds/${STAGE3_URL}
